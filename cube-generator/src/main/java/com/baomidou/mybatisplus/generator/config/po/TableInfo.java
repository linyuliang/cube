...
public class TableInfo {
  ...
  private String keyIdentityPropertyName;//主键自增长的ID，对应的属性名称
    ...
    if (CollectionUtils.isNotEmpty(fields)) {
      ...
      for (TableField field : fields) {
        ...
        if (field.isKeyFlag()) {
          ...
          // 存在generatorKey
          if (field.getGeneratedKeyInfo() != null) {
            pkgSet.add("javax.persistence.GeneratedValue");
            pkgSet.add("javax.persistence.GenerationType");
          }
  ...
  public String getKeyIdentityPropertyName() {
    return keyIdentityPropertyName;
  }

  public void setKeyIdentityPropertyName(String keyIdentityPropertyName) {
    this.keyIdentityPropertyName = keyIdentityPropertyName;
  }
