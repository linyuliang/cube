...
public class StrategyConfig {
   ...
   */
  private GeneratedTableInfo[] include = null;
  ...
  public GeneratedTableInfo[] getInclude() {
    return include;
  }

  public StrategyConfig setInclude(GeneratedTableInfo[] include) {
  ...
  public StrategyConfig setEntityBooleanColumnRemoveIsPrefix(
      boolean entityBooleanColumnRemoveIsPrefix) {
